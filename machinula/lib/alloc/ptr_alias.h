    ...
    namespace ptr
    {
        ...
        class shared_ptr final : public alias::shared_ptr< PtrType >
        {
            public:
                ...
                : alias::shared_ptr< PtrType >( ptr, deleter_functor< DerrivedPtrType >( a ), stl_adapter< DerrivedPtrType >( a ) )
                { }
                ...
                : alias::shared_ptr< PtrType >( (shared_ptr< PtrType >&)other )
                { }
                ...
                template < typename DerrivedPtrType >
                shared_ptr( const shared_ptr< DerrivedPtrType > && other )
                : alias::shared_ptr< PtrType >( (shared_ptr< DerrivedPtrType >&&)other )
                { }
